...
{
    Console.WriteLine($"Posição Numero {contadorArray} : {valor}");
    contadorArray++;
}

//redimensionando um array

Array.Resize(ref array2, array2.Length*2); //dobra o tamanho do array2
...
for (int contador = 0; contador < nomeDaLista.Count; contador++) //o metodo Count substitui o metodo lenght em listas
{
